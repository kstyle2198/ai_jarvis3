...
INIT_PRE_RECORDING_BUFFER_DURATION = 0.6
...
class AudioToTextRecorder:
    ...
    def __init__(self,
        ...
        log_format = 'STT: %(name)s - %(levelname)s - %(message)s'
        ...
        if not no_log_file:
            ...
            file_handler = logging.FileHandler('sst.log')
        ...
        logging.debug('STT initialization completed successfully')
    ...
    def shutdown(self):
        ...
        with self.shutdown_lock:
            ...
            print("\033[91mSTT shutting down\033[0m")
            # logging.debug("STT shutting down")
