...
# total_results =[]
def main_filepath_extractor(path:str, total_results:list=[]) -> list:   # 폴더 트리를 리커시브하게 읽어서 전체 PDF 파일의 full 경로를 리스트에 수집 
...
class MyParser:
    ...
    def parser(path:str, crop:bool=False, lang:str="en") -> Iterator[Document]:  # 메인 Parsing 함수, text-extraction은 pypdf2 적용
        '''
